...
export function Features() {
  return (
    <section id="ventajas" className="py-20 md:py-24">
      <div className="container-app grid items-center gap-10 lg:grid-cols-[1fr_1.05fr]">
        <SectionReveal>
          <div>
            <h2 className="section-title">¿Por qué elegirnos?</h2>
            <p className="section-subtitle">
              Somos el socio logístico que te ayuda a importar con control, confianza y acompañamiento en cada etapa del proceso.
            </p>

            <div className="mt-10 grid gap-5 sm:grid-cols-2">
              {stats.map((stat) => (
                <div key={stat.title} className="rounded-2xl border border-slate-200 bg-white p-5 shadow-soft">
        ...
        <SectionReveal>
          <div className="relative overflow-hidden rounded-[32px] shadow-2xl">
            ...
            <div className="absolute bottom-6 left-6 rounded-3xl bg-primary p-6 text-white shadow-xl">
              ...
              <p className="mt-1 font-medium">Satisfacción orientada al cliente</p>
            </div>
            <div className="absolute right-6 top-6 rounded-2xl bg-white/90 px-4 py-3 text-slate-900 backdrop-blur">
              <p className="flex items-center gap-2 text-sm font-semibold"><CheckCircle2 className="text-primary" size={18} /> Seguimiento operativo</p>
            </div>
          </div>
        </SectionReveal>
      </div>
