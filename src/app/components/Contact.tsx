...
export function Contact() {
  ...
  return (
    <section id="contacto" className="bg-slate-50 py-20 md:py-15">
      <div className="container-app">
        <SectionReveal>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl lg:text-5xl">Solicita tu Cotización</h2>
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <SectionReveal>
            <form
              ...
              className="rounded-[28px] bg-white p-6 shadow-soft md:p-8"
            >
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <div className="md:col-span-2">
                  <label className="mb-2 block text-sm font-semibold text-slate-700">
                    Mensaje / detalles de la carga *
                  </label>
                  <textarea
                    {...register("message", { required: "Describe tu carga" })}
                    rows={5}
                    className="w-full rounded-xl border border-slate-200 px-4 py-3 outline-none transition focus:border-primary"
                    placeholder="Tipo de producto, peso, volumen, dimensiones, fecha estimada, etc."
                  />
                  {errors.message && (
                    <p className="mt-1 text-sm text-red-500">
              ...
              <button
                type="submit"
                className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-6 py-3.5 font-semibold text-white transition hover:bg-orange-600"
              >
                    ...
                    <div key={card.title} className="flex gap-4">
                      ...
                      <div>
                        ...
                        {card.content.map((line) => (
                          <p key={line} className="mt-1 text-slate-500">
                            {line}
                          </p>
                        ))}
                      </div>
              ...
              <div className="rounded-[28px] bg-cta p-8 text-white shadow-2xl">
                ...
                <div className="mt-4 space-y-2 text-slate-200">
                  ...
                  <p className="pt-2 text-sm text-slate-300">
                    Atención 24/7 para seguimiento de envíos.
                  </p>
                </div>
              </div>
            </div>
