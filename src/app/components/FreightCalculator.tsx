...
Tiempo estimado: ${calculation.estimatedDays}`
  ...
  return (
    <section id="calculadora" className="bg-slate-50 py-20 lg:py-13">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-xl sm:p-8 lg:p-10">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
            ...
            <div className="rounded-[24px] bg-gradient-to-br from-slate-950 via-slate-900 to-[#071a3a] p-6 text-white shadow-2xl sm:p-8">
